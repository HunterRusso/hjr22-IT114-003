...
public class Payload implements Serializable {
    ...
    public String toString() {
        return String.format("ClientId[%s], ClientName[%s],Type[%s], Category[%s], Question[%s], Options[%s], Number[%s], Message[%s]",
        getClientId(), getClientName(), getPayloadType().toString(), getCategory(), getQuestion(), getOptions(), getNumber(), getMessage());
    }
